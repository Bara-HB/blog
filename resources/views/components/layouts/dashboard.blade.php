    ...
    <div class="flex flex-wrap">
      ...
      <div class="space-y-4 m-4 md:w-1/3 flex">
          <div class="flex items-center max-w-2xl overflow-hidden bg-white border rounded-lg shadow-sm border-neutral-200/60">
              <img src="{{ asset($item->image_path) }}" class="object-cover w-auto h-48 aspect-video" />
              <div class="p-8">
                  ...
                  <form action="/dashboard_delete" method="POST" name="id">
                    ...
                    <button class="mt-4 inline-flex items-center justify-between w-auto h-10 px-4 py-2 text-sm font-medium bg-white transition-colors rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none bg-neutral-950 hover:bg-neutral-950/90"">Smazat</button>
                  </form>
              </div>
          </div>
      </div>
